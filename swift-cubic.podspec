#
#  Be sure to run `pod spec lint swift-cubic.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Cobalt Speech & Language" => "info@cobaltspeech.com" }
  # Or just: spec.author    = "Cobalt Speech & Language"
  # spec.authors            = { "Cobalt Speech & Language" => "info@cobaltspeech.com" }
  # spec.social_media_url   = "https://twitter.com/Cobalt Speech & Language"
  ...
  spec.source       = { :git => "https://github.com/cobaltspeech/swift-cubic.git", :tag => spec.version.to_s }
